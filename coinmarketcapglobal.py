...
print('The global cap of al cryptos is '+global_cap_string+' and the 24 hour global volume is '+global_volume_string)
print('Bitcoin\'s total percentages of the global cap is '+str(bitcoin_percentage)+ '.')
